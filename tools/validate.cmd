...
call ajv validate -s ListOfSupplierOrders.schema.json -d "..\3.0.0\mock\GW01&BW01.get-supplier-orders.response.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s SupplierOrderById.schema.json -d "..\3.0.0\mock\GW02&BW02.get-supplier-orders-supplierOrderId.response.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s ListOfLogisticsDeliveryNotes.schema.json -d "..\3.0.0\mock\GW03&BW03.get-logistic-delivery-notes.response.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s LogisticsDeliveryNoteById.schema.json -d "..\3.0.0\mock\GW04&BW04.get-logistic-delivery-notes-logisticDeliveryNoteId.response.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s LogisticsGoodsReceiptById.schema.json -d "..\3.0.0\mock\GW05&BW05.post-logistic-goods-receipts.request.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s LogisticsGoodsReceiptById.schema.json -d "..\3.0.0\mock\BW06.put-logistic-goods-receipts-logisticGoodReceiptId.request.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s ListOfDeliveryInstructions.schema.json -d "..\3.0.0\mock\GW06&BW07.get-delivery-instructions.response.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s DeliveryInstructionById.schema.json -d "..\3.0.0\mock\GW07.get-delivery-instructions-deliveryInstructionId.response.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s DeliveryInstructionById.schema.json -d "..\3.0.0\mock\BW08.get-delivery-instructions-deliveryInstructionId.response.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s LogisticsDeliveryNoteById.schema.json -d "..\3.0.0\mock\GW08.post-logistic-delivery-notes.request.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s LogisticsDeliveryNoteById.schema.json -d "..\3.0.0\mock\BW09.post-logistic-delivery-notes.request.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
...
call ajv validate -s LogisticsDeliveryNoteById.schema.json -d "..\3.0.0\mock\BW10.put-logistic-delivery-notes-logisticDeliveryNoteId.request.json" --strict=false -c ajv-formats --verbose
@echo on
@echo off
